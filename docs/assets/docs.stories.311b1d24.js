...
<\/script>
`)),e("h2",null,"Usage"),e("p",null,"No props usage:"),e("pre",null,e("code",{parentName:"pre",className:"language-vue"},`<template>
...
<\/script>
`)),e("h3",null,"Props"),e("h4",null,"draggable"),e("p",null,"Type: ",e("inlineCode",{parentName:"p"},"Boolean"),`
...
`)),e("h3",null,"Events"),e("h4",null,"activated"),e("p",null,"Parameters: ",e("inlineCode",{parentName:"p"},"-")),e("p",null,"Called whenever the component gets clicked, in order to show handles."),e("pre",null,e("code",{parentName:"pre",className:"language-vue"},`<draggable-resizable-vue @activated="onActivated">
...
`)),e("h2",null,"Contributing"),e("p",null,"Any contribution to the code or any part of the documentation and any idea and/or suggestion are very welcome."),e("pre",null,e("code",{parentName:"pre",className:"language-bash"},`# serve with hot reload at localhost:5173
npm run dev
