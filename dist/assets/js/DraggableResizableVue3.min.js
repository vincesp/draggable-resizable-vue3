...
const DraggableResizableVue3_vue_vue_type_style_index_0_lang = "";
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "50e0a548": unref(handlesSize),
      "7720e6ca": unref(handlesHalfSize)
    }));
    const events = {
      mouse: {
        start: "mousedown",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        class: normalizeClass([
          {
            [__props.classNameActive]: unref(active),
        ...
        createBaseVNode("div", {
          class: normalizeClass("drv-" + __props.handlesType)
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(actualHandles), (handleEl) => {
            return openBlock(), createElementBlock("div", {
              key: handleEl,
              class: normalizeClass([
                __props.classNameHandle,
                __props.classNameHandle + "-" + handleEl,
                __props.classNameHandle !== "drv-handle" ? "drv-handle" : "",
                __props.classNameHandle !== "drv-handle" ? "drv-handle-" + handleEl : ""
              ]),
              style: normalizeStyle({
                display: unref(active) ? "block" : "none"
              }),
              ...
              unref(slots)["handle-" + handleEl] ? renderSlot(_ctx.$slots, "handle-" + handleEl, { key: 0 }) : createCommentVNode("", true),
              !unref(slots)["handle-" + handleEl] ? renderSlot(_ctx.$slots, "handle", { key: 1 }) : createCommentVNode("", true)
            ], 46, _hoisted_1$1);
          }), 128))
        ], 2),
...
const _sfc_main = {
  __name: "App",
  setup(__props) {
    ref({ x: 100, y: 100, w: 100, h: 100, active: false });
        ...
        createBaseVNode("div", null, [
          createBaseVNode("div", _hoisted_2, [
            ...
            createVNode(unref(_sfc_main$1), {
              x: position2.value.x,
              "onUpdate:x": _cache[0] || (_cache[0] = ($event) => position2.value.x = $event),
              y: position2.value.y,
              "onUpdate:y": _cache[1] || (_cache[1] = ($event) => position2.value.y = $event),
              h: position2.value.h,
              "onUpdate:h": _cache[2] || (_cache[2] = ($event) => position2.value.h = $event),
              w: position2.value.w,
              "onUpdate:w": _cache[3] || (_cache[3] = ($event) => position2.value.w = $event),
              active: position2.value.active,
              "onUpdate:active": _cache[4] || (_cache[4] = ($event) => position2.value.active = $event),
              scale: 0.3,
...
const DraggableResizableVue3Borders = "";
const DraggableResizableVue3Handles = "";
