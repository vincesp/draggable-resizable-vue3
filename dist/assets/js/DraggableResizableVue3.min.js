  ...
  setup(__props, { emit }) {
    ...
    const elementDown = (e) => {
      ...
      if (el.value.contains(target)) {
        ...
        mouseClickPosition.value.mouseX = e.touches
          ? e.touches[0].pageX
          : e.pageX
        mouseClickPosition.value.mouseY = e.touches
          ? e.touches[0].pageY
          : e.pageY
            ...
            return openBlock(), createElementBlock("div", {
              ...
              onMousedown: withModifiers(($event) => handleDown(handleEl, $event), ["stop", "prevent"]),
                          onTouchstart: withModifiers(
                            ($event) => handleTouchDown(handleEl, $event),
                            ['stop', 'prevent'],
                          ),
                        },
                        [
...
const _hoisted_2 = {
  style: { background: 'aqua', width: '771px', height: '500px' },
}
          ...
          createBaseVNode("div", _hoisted_2, [
            ...
            createVNode(unref(_sfc_main$1), {
              x: position2.value.x,
                  'onUpdate:x':
                    _cache[0] ||
                    (_cache[0] = ($event) => (position2.value.x = $event)),
              y: position2.value.y,
                  'onUpdate:y':
                    _cache[1] ||
                    (_cache[1] = ($event) => (position2.value.y = $event)),
              h: position2.value.h,
                  'onUpdate:h':
                    _cache[2] ||
                    (_cache[2] = ($event) => (position2.value.h = $event)),
              w: position2.value.w,
                  'onUpdate:w':
                    _cache[3] ||
                    (_cache[3] = ($event) => (position2.value.w = $event)),
