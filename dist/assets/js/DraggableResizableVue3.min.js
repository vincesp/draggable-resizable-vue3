(function(){"use strict";try{var r=document.createElement("style");r.appendChild(document.createTextNode(`.drv {\r
  touch-action: none;\r
  position: absolute;\r
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(actualHandles), (handleEl) => {
            return openBlock(), createElementBlock("div", {
              ...
              style: normalizeStyle({
                ...
                border: unref(slots).handle ? "" : "0.5px solid gray"
              }),
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    ref({ x: 100, y: 100, w: 100, h: 100, active: true });
    return (_ctx, _cache) => {
