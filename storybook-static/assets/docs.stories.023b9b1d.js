...
`)),e("p",null,"Usage with grid:"),e("pre",null,e("code",{parentName:"pre",className:"language-vue"},`<template>
        <draggable-resizable-vue
          v-model:x="element.x"
          v-model:y="element.y"
...
`)),e("hr",null),e("h2",null,"Contributing"),e("p",null,"Any contribution to the code or any part of the documentation and any idea and/or suggestion are very welcome."),e("pre",null,e("code",{parentName:"pre",className:"language-bash"},`# serve with hot reload at localhost:8080
npm run serve
...
//# sourceMappingURL=docs.stories.023b9b1d.js.map
